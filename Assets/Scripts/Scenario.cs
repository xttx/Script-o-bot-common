...
void Start ()
{
  for (int i = 0; i < 10; i++) {
    ...
    public static void Init()
    {
		...
		Step_Add_Dialog_Continue ("То есть, сначала проверяется первая часть, потом вторая, и, поскольку обе эти части связаны оператором _ИЛИ_, то, если <i>хоть одна из них истинна</i> - всё условие тоже будет истинным.\n");
